import type { SignupInput } from "@iam_npm/medium-common"
        ...
        <div className="flex justify-center">
            <div className="px-10 " >
                ...
                <div className="pt-3">
                    ...
                    <button onClick={sendRequest} type="button" className="mt-8 w-full text-white bg-gray-900 hover:bg-black focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2">{type === "signup" ? "Sign up" : "Sign in"}</button>
